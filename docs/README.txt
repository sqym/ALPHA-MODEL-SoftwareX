...
----------------------------------------------------------------------------------------------------------------------------
Considering this, we packaged the project into a executable software in the ALPHA MODEL folder. You can download this folder, open and click the "ALPHA MODEL .exe" to run this program without Qt creator. We recommend you to run the program in this way.
----------------------------------------------------------------------------------------------------------------------------
